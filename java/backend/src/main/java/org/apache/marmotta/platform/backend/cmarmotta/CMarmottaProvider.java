...
package org.apache.marmotta.platform.backend.cmarmotta;
 ...
 */
@ApplicationScoped
public class CMarmottaProvider implements StoreProvider {
    ...
    public NotifyingSail createStore() {
        ...
        return new CMarmottaSail(
                configurationService.getStringConfiguration("cmarmotta.host", "localhost"),
                configurationService.getIntConfiguration("cmarmotta.port", 10000));
    }
